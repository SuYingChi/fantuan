...
public interface MyPhotoView {
    ...
    /**
     * Will return instance of MyPhotoView (eg. PhotoViewAttacher), can be used to provide better
     * integration
     *
     * @return MyPhotoView implementation instance if available, null if not
     */
    MyPhotoView getIPhotoViewImplementation();
