...
public class WeexLocalActivity extends BaseActivity implements IWXRenderListener {
    /**
     * @param context
...
//    options.put(WXSDKInstance.BUNDLE_URL,"file://Fan3.js");
        mWXSDKInstance.render("WXSample",
                WXFileUtils.loadAsset(getIntent().getStringExtra("jsname"),
                        this), null, null,
