...
public class ResultAdapter extends RecyclerView.Adapter {
    private List<SearchResult.DataBean.MerchantsBean> list;
    private Context mActivity;

    public ResultAdapter(List<SearchResult.DataBean.MerchantsBean> list, Context mActivity) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new OrderViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.item_qresult, parent, false));
