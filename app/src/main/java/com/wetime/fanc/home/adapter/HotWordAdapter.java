...
public class HotWordAdapter extends RecyclerView.Adapter {
    private List<HomeHotSearchBean.DataBean.MerchantHotsBean> list;
    private Context mActivity;

    public HotWordAdapter(List<HomeHotSearchBean.DataBean.MerchantHotsBean> list, Context mActivity) {
        this.list = list;
