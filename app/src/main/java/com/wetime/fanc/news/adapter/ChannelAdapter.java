...
import com.wetime.fanc.news.helper.OnDragVHListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<ChannelBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ChannelBean> mMyChannelItems, List<ChannelBean> mOtherChannelItems) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        ChannelBean item = mMyChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ChannelBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
