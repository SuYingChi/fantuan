...
public class SCategoruItemAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<CategoryBean.SubcatesBean> mData;
    ...
    public SCategoruItemAdapter(Context context, List<CategoryBean.SubcatesBean> mData) {
