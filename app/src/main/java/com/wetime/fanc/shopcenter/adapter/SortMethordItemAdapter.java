...
public class SortMethordItemAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<SortMethordBean> mData;
    private Context mContext;
    private String selectedid = "";

    public SortMethordItemAdapter(Context context, List<SortMethordBean> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (selectedid.equals("")) {
            ...
            if (selectedid.equals(mData.get(position).getSort())) {
                holder.tvname.setTextColor(Color.parseColor("#ff3f53"));
            } else {
                holder.tvname.setTextColor(Color.parseColor("#333333"));
            }
